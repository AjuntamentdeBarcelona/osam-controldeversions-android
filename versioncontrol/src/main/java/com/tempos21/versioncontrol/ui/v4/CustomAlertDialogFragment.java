package com.tempos21.versioncontrol.ui.v4;
...
public class CustomAlertDialogFragment extends DialogFragment {
    ...
    private Dialog createDialog(AlertMessageModel alertMessage) {
        ...
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(getActivity(),  R.style.VersionControlCustomAlertDialogV4);
